...
02.|20 73 74 72 69 6e 67 21 08 08 08 08 08 08 08 08 | | string!........|
   +------------------------------------------------+ +----------------+
See? With CBC the cipher is different every time.
```

# Don't use ECB though...

As you can see, the cipher with ECC is always the same, whereas with CBC it changes every time, preventing the [easier attacks on the cipher](https://cryptopals.com/sets/2).